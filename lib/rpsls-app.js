...
ServerApp.prototype.getChallengesForUser = function (user, fn) {
...
ServerApp.prototype.getActiveChallengesForUser = function (user, fn) {
    this.getChallengesForUser(user, function (data) {
        app.getActiveChallenges(data, fn);
    });
};
...
ServerApp.prototype.getUsersChallenges = function (req, res) {
    //TODO: use req.query["active"]
    var user = req.params.name;
    app.getActiveChallengesForUser(user, function (data) {
        res.send(data);
    });
};
