...
ServerApp.prototype.challenge = function (req, res) {
    ...
    //TODO: challengesIO io.challenges.emit(user, challenge) or io.challenges.volatile.emit(user, challenge)
    //      emit result of getUsersChallenges
...
ServerApp.prototype.makeMove = function (req, res) {
    ...
    //TODO: resultsIO io.results.emit(user, challenge) or io.results.volatile.emit(user, challenge)
    //      emit result of getChallenge
