...
describe('RestService', function () {
    ...
    beforeEach(function (done) {
        require('./spec/testdata').createTestData(require('fakeredis').createClient('testdb'), done);
    });
    ...
    describe('/user', function(){
        it("should return all users", function (done) {
            request(url + "/user", function (error, response, body) {
                ...
                body.should.include('Craig');
                body.should.include('BoyCook');
                body.should.include('Superman');
                body.should.include('Hulk');
                done();
            });
        });
        ...
        it("should return a given user", function (done) {
            request(url + "/user/BoyCook", function (error, response, body) {
                body = JSON.parse(body);
//            body.should.equal(expectedBoyCook);
//            assert.equal(body, expectedBoyCook);
                done();
            });
        });
    ...
    describe('challenge', function(){
        it("should return all challenges", function (done) {
            request(url + "/challenge", function (error, response, body) {
                ...
                body.should.include('BoyCook:Craig:1');
                done();
            });
        });
